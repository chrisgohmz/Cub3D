...
SRCS = $(addprefix $(SRCS_DIR), main.c init.c events.c render_map.c\
		 ...
		 ray_casting.c scene.c scene_utils1.c scene_utils2.c scene_utils3.c image.c parsing.c doors_enemies.c elements_utils.c elements.c floor_ceiling.c map_utils.c map.c walls_doors.c sprite.c sprite_utils1.c sprite_utils2.c sprite_utils3.c door.c free.c)
DEPS = $(SRCS:.c=.d)
OBJS = $(SRCS:.c=.o)
